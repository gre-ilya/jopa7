...
**MSVC 2017+** или MinGW, как и у самого GPSBabel.

> Замечание о тестировании: сборка и runtime проверены мной на Linux (g++ 13,
> Qt 5.15) в обоих режимах zlib. Под MSVC я не запускал сборку в этой среде, но
> модуль использует ровно тот же набор исходников и дефайнов, который GPSBabel
> штатно собирает под Windows.
